...
class MapScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final valid = providers.where((p) => p.latitude != 0 && p.longitude != 0).toList();
    ...
    return Scaffold(
      ...
      body: FlutterMap(
        ...
        children: [
          TileLayer(urlTemplate: 'https://tile.openstreetmap.org/{z}/{x}/{y}.png', userAgentPackageName: 'com.beautyapp.map'),
          MarkerLayer(
