...
router.get('/bookings/provider', authMiddleware, bookingController.getProviderBookings);

// 🔹 HISTORIAL DE CITAS DEL CLIENTE
router.get('/bookings/client', authMiddleware, bookingController.getClientBookings);

// 🔹 ACTUALIZAR ESTADO DE CITA
router.patch('/bookings/:id/status', authMiddleware, bookingController.updateBookingStatus);
...
// 🔹 INICIAR SERVICIO
router.patch('/bookings/:id/start', authMiddleware, bookingController.startService);
