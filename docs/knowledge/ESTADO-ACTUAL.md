...
| O-015 | ensayo del tren aceptado (5 ramas) sobre el vehículo | `integracion/tren-a` (local) | **emitida 2026-09-25**, sin entregar: mapa de conflictos + suites por merge + orden de aterrizaje |
