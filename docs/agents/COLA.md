...
| O-012 | **Orden A-06** — hacer reproducible la compuerta de credenciales (fin de línea), acotar su alcance a código/configuración y darle autotest | Ejecutor | `fix/compuerta-secretos-reproducible` | **pendiente** | `docs/agents/ordenes/PROMPT-ANTIGRAVITY-A-06-2026-09-24.md` | — (va **antes** que A-01: el run muere en este paso) |
